            ...
            <div className="content">
                <button onClick={() => history.goBack()} className="linkBack"><VscArrowLeft/> Voltar</button>
                  ...
                  <div className="text">
                        ...
                        O Converta coleta e processa grandes volumes de dados, atuando na proteção e privacidade destes. Ao utilizar os Serviços do Converta, de seus parceiros ou ao fazer negócio com um lojista que utiliza os Serviços da Converta, você concorda com os termos desta Política de privacidade e, quando aplicável, com os Termos de serviço da Converta.
                  </div>
                  <ul>
